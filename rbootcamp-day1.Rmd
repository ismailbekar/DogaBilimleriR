...
author: "Bilgecan Sen, Nurbahar Usta, İsmail Bekar"
output:
...
- Part 1: <a href = "#/3"> R Programlamaya Giriş </a>
- Part 2: <a href = "#/30"> Homojen Veri Yapıları </a>
- Part 3: <a href = "#/93"> Loops and Flow İfadeleri </a>
- Part 4: <a href = "#/116"> Fonksiyonlar </a>
- Part 5: <a href = "#/133"> Heterojen Veri Yapıları </a>
- Part 6: <a href = "#/172"> Temel Görselleştirme </a>
- Part 7: <a href = "#/172"> Kapanış </a> 



# Part 1: R Programlamaya Giriş
...
2. "A" ve 1 içeren bir vektör oluşturunç
3. TRUE ve "C" içeren bir vektör oluşturun.
4. Örüntüyü farkettiniz mi? Oluşturduğunuz vektörleri modu nasıl belirlendi? 



## R İpucu: Zorla güzellik olmaz

Atomic bir vektörün tüm elementleri aynı tipte olmalıdır. Yani birbirinden farklı elementleri birleştirmeye çalıştığınızda otomatik olarak en esnek tipte birleşeceklerdir. En esnek tipler en az esnek olandan başlalayarak şu şekilde sıralanır: logical, integer, double, and character.
...
- iki tane 5'e 2lik matriks oluşturun. Bir tanesi 1-2* arasındaki tüm çift sayıları içermeli, diğeri tüm tek sayıları. Matriksleri satırlara göre doldurdun.
...
- 9 ve 11. günlerde hasta oldunuz (geçmiş olsun!). Bu günleri "hasta" olarak değiştirin. Matriksteki diğer girdiler bundan nasıl etkilendi?
...
# Part 3: Loops and Flow İfadeleri
...
- Yukarıdaki kodu çalıştırın.
- Yeni bir veriseti oluşturun ve bu verisetinde 10 veya 10'dan daha az kenesi olan hayvanlara 0, 10'dan daha fazla kenesi olanlara 1 atayın. Bunu loop kullanarka yapın. Daha sonra loop kullanmadan yapın.
...
# Part 5: Heterojen Veri Yapıları
...
1. `iris` veri setinde  sütunundaki 9. elementi bulun?
...
5. `iris` `Sepal.Width` sütununu silin ve başka bir objeye atayın.

6.  Bir veri setinde `length()` fonksiyonunu kullandığınızda ne sonuç alıyorsunuz? Matriksten farkı ne?

7. `iris`  veri setinde petal uzunluğu 3'den büyük olanları seçin.
...
- Listeler aynı anda herhangi bir tipte elementi ve classı barındırabilir.
